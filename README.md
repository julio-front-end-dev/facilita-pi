...
dentro de uma única pasta no seu computador (ex: uma pasta chamada facilita-pi).
...
aparecer na lista de arquivos para subir, pois ele está listado no seu .gitignore. Se ele aparecer, o GitHub Desktop ainda não reconheceu o ignore; certifique-se de que o arquivo chama-se exatamente .gitignore.
...
Eixo da Computação | Grupo - 18 | Univesp - 2026
